...
function __mc4wp_admin_sidebar_support_notice() {
	...
	<div class="mc4wp-box">
		...
		<p><?php echo sprintf( __( 'Found a bug? Please <a href="%s">open an issue on GitHub</a>.' ), 'https://github.com/ibericode/mailchimp-for-wordpress-custom/issues' ); ?></p>
	</div>
	<?php
}
...
/**
 * Runs when the sidebar is outputted on MailChimp for WordPress Custom settings pages.
 *
